...
class DomoticGateway:
    ...
    def conectar_serial(self):
        try:
            ...
            raise e
    # ENCARGADO DE PYTHON_CORE_SERIAL DEBE AÑADIR AQUI FUNCION enviar_trama #

    def enviar_correo_alerta(self, distancia):
        try:
            msg = MIMEText(f"CRÍTICO: Se ha detectado un intruso a una distancia de {distancia} cm.")
    ...
    def iniciar(self):
        ...
        try:
            while True:
                ...
                # ENCARGADO DE PYTHON_CORE_SERIAL DEBE LLAMAR A self.enviar_trama() PARA CADA MENSAJE #
                if opc == '6':
                    break
                else:
                    # ENCARGADO DE PYTHON_CORE_SERIAL DEBE REMPLAZAR PRINT #
